 ...
 * and forwards requests to the actual create distribution function
 */
...
exports.handler = async (event) => {
  ...
  try {
    // Call the actual create distribution function
    const result = await lambdaClient.send(new InvokeCommand({
      FunctionName: process.env.TARGET_FUNCTION_NAME || 'CfManagerBackendStack-CreateDistributionFunction5F-8dVytjuIERtv',
